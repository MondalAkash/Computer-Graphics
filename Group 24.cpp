...
int main(int argc, char** argv) {
 ...
 system("cls");
    ...
    cout<<"Group Members: "<<endl<<"\n\t1.Akash Mondal => 15-28764-1"<<endl<<"\t2.Anika Azad => 15-28662-1"<<endl<<"\t3.M.Tanzeeb Rubaiat Haque => 15-28809-1"<<endl<<"\t4.S M Fahim Shahriar => 15-28836-1"<<endl<<endl;
    cout<<"\n\t\t\tProject Topic: Village Scenario"<<endl;
    int c;
    cout<<"\n\nPress <1> (ONE) To See The Scenario"<<endl<<endl<<"Input: ";
    cin>>c;
    if(c==1)
    {
        system("cls");
     ...
     cout<<endl;
     system("cls");
     cout<<"Press U for Moving Sun Upward\n";
     cout<<"Press D for Moving Sun Downward\n";
     cout<<"Press R for Speeding Up The Car\n";
     cout<<"Press B for Speeding Down The Car\n";
     cout<<"Press I for Speeding Up The Boats\n";
     cout<<"Press S for Speeding Down The Car\n";
     glutInit(&argc, argv);
